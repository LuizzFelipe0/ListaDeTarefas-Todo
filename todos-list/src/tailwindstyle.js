...
backg: `h-screen w-screen p-4 bg-gradient-to-t from-[#18191b] to-[#6119c5]`,
container: `bg-zinc-100 max-w-[500px] w-full m-auto rounded-lg shadow-2xl shadow-zinc-900 mt-40 p-4 `,
heading: `text-4xl  font-bold text-center text-violet-600 p-4 my-3`,
...
list: `flex justify-between bg-violet-400 rounded-md p-4 my-4 capitalize `,
row: `flex`,
